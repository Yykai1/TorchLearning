# # -*- coding:utf-8 -*-
# # @Time    : 2022/4/29 14:54
# # @Author  : Yinkai Yang
# # @FileName: rnn_predict.py
# # @Software: PyCharm
...
#
# # 开始训练模型
# # input --->  x：[seq_len, batch, input_size]，h0：[num_layers, batch, hidden_size]
...
#
#         if iter % 100 == 0:
#             print(f"Iteration: {iter:>5d} loss {loss.item():>8f}")
#             l.append(loss.item())
#
#     # 绘制损失函数
#     plt.plot(l, 'r')
